...
import CountryFlagDropdown from './PhoneInput';
...
const CustomForm = ({ page, message }) => {
    ...
    const onSubmit = async (data) => {
        ...
        const userData = {
            ...
            userPhnNo: countryCode?.phoneCode + data?.phoneNumber,
                        ...
                        isOtpSent ? (
                            ...
                            <div>
                                <div className="flex justify-start items-start gap-2 mb-2">
                                    <label className="input input-bordered flex justify-start items-center gap-2 focus:outline-none focus:border-blue-500 w-full text-black">
                                ...
                                {errors.phoneNumber && <span className='text-red-600'>Invalid PhoneNo</span>}
